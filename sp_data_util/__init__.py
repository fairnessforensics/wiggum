...
from .SPData import geometric_indep_views_gmm_sp,data_only_geometric_2d_gmm
from .spplots import sp_plot


__all__ = ['simple_regression_sp', 'noise_regression_sp', 'generateDataset',
           'mixed_regression_sp_extra','sp_plot', 'geometric_2d_gmm_sp',
           'geometric_indep_views_gmm_sp','data_only_geometric_2d_gmm']
