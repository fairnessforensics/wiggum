...
class _ResultDataFrame():
    ...
    def add_view_score(self,score_col,agg_type='mean',colored=False):
        ...
        colored : Boolean [default=False]
            colored (including a splitby) views or not
        ...
        if colored:
            ...
            view_vars = ['independent','dependent','splitby']
        else:
            view_name = 'view'
    ...
    #
        ...
        for i,r in enumerate(self.result_df[['independent','dependent','splitby']].values):
    ...
    def get_trend_rows(self,independent = None,dependent = None,splitby= None,
        ...
        if splitby:
            gf_rows = pd.Series([gf in splitby for gf in self.result_df['splitby']])
        else:
            gf_rows = True
    ...
    def count_sp_views(self, sp_col = 'SP',colored= False, portions =False,
        ...
        colored_view_vars = ['independent','dependent', 'splitby']
        ...
        if portions :
            ...
            splitby_list = set(self.result_df.splitby.values)
            ...
            levels_per_sp_view = [levels_by_attr[a] for a in count_df['splitby']]
    ...
    def rank_occurences_by_view(self,view_score=None,occurence_score=None,
        ...
        colored : Boolean [False]
            views defined by independent, dependent, and splitby if True, otherwise
