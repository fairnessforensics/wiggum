...
function drawGraph_bak(data) {
	...
	for (var i = 0; i < correlationMatrixSubgroup.length; i++){
		...
		//subgroupMatrix = jsonto2darray(JSON.parse(correlationMatrixSubgroup[i]))

		//var bivariateMatrix = BivariateMatrix(correlationMatrix, subgroupMatrix);
